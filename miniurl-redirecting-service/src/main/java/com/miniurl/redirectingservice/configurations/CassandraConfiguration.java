package com.miniurl.redirectingservice.configurations;
...
/** Configuration class for Cassandra DB. */
@Configuration
public class CassandraConfiguration {
  ...
  CqlSession getAwsCqlSession() {
    ...
    DriverConfigLoader configLoader =
        DriverConfigLoader.fromClasspath(
            cassandraConfig.replace(
                RedirectingServiceConstants.FILE_PREFIX, RedirectingServiceConstants.EMPTY_STRING));
