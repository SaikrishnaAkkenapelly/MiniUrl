...
public class CassandraConfiguration {
	...
	CqlSession getAwsCqlSession() {
		...
		DriverConfigLoader configLoader = DriverConfigLoader.fromClasspath(
				cassandraConfig.replace(TokenServiceConstants.FILE_PREFIX, TokenServiceConstants.EMPTY_STRING));
